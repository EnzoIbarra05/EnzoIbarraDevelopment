      ...
      <div className="cards-container">
        ...
        <div className="card">
          ...
          <div className="card-content">
            ...
            <a
              className="link-button"
              href="https://ferreteria-im.vercel.app/"
              target="_blank"
              rel="noopener noreferrer"
            >
              Ver página
        ...
        <div className="card">
          ...
          <div className="card-content">
            ...
            <div className="tecnologias">
              <span className="usado">React-vite</span>
              <span className="usado">CSS</span>
              <span className="usado">HTML</span>
              <span className="usado">Figma</span>
              <span className="usado">Frontend</span>
            </div>
        ...
        <div className="card">
          <div className="carousel carousel-3">
            ...
            <img src="/img/landingVisua.png" alt="Vista 4" />
          </div>
          <div className="card-content">
            ...
            <a
              className="link-button"
              href="https://visua-landing.vercel.app/"
              target="_blank"
              rel="noopener noreferrer"
            >
              Ver página
        ...
        <div className="card">
          <div className="carousel carousel-3">
            <img src="/img/27-1.png" alt="Vista 1" />
            <img src="/img/27-2.png" alt="Vista 2" />
            <img src="/img/27-3.png" alt="Vista 3" />
          </div>
          <div className="card-content">
            <h2>KPI Manager 27 de julio S.R.L</h2>
            <p id="parraf">
              Aplicacion web profesional para administracion y control de KPI´S de importante empresa.
            </p>
            <div className="tecnologias">
              <span className="usado">Java-Spring</span>
              <span className="usado">React-vite</span>
              <span className="usado">SQL</span>
              <span className="usado">Docker-servidor</span>
            </div>

            <a
              className="link-button"
              href="https://27dejuliokpi.com"
              target="_blank"
              rel="noopener noreferrer"
            >
              Ver página
